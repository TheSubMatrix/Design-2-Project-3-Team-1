...
{ 
    public static class GenericJSONSerialization
    {
        ...
        /// <summary>
        /// Retrieves all file paths within the specified folder.
        /// </summary>
        /// <param name="folderPath">The path to the folder to search for files.</param>
        /// <returns>
        /// A list of file paths as strings found in the folder.
        ...
        /// <summary>
        /// Generates a new filename by appending an incremental number to the base filename
        /// to avoid overwriting existing files in the specified directory.
        /// </summary>
        /// <param name="filename">The base filename without extension.</param>
        /// <param name="filePath">The directory path where the file will be stored.</param>
        /// <returns>
        /// A full file path with the new filename and ".json" extension that does not conflict
